...
namespace PharmaGo.Test.DataAccess.Test
{
    ...
    public class PurchasesDetailRepositoryTest
    {
        ...
        public void InitializeTest()
        {
            ...
            purchaseDetail = new PurchaseDetail { Quantity = 2, Price = new decimal(100), Item = drug1, Pharmacy = pharmacy };
            purchaseDetail_2 = new PurchaseDetail { Quantity = 1, Price = new decimal(250), Item = drug2, Pharmacy = pharmacy_2 };
        }
