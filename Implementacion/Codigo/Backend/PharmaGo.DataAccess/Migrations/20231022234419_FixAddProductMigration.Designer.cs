...
namespace PharmaGo.DataAccess.Migrations
{
    ...
    [Migration("20231022234419_FixAddProductMigration")]
    partial class FixAddProductMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaGo.Domain.Entities.PharmacyItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PharmacyItem");

                    b.HasDiscriminator<string>("Discriminator").HasValue("PharmacyItem");
                });
            ...
            modelBuilder.Entity("PharmaGo.Domain.Entities.Drug", b =>
                {
                    b.HasBaseType("PharmaGo.Domain.Entities.PharmacyItem");
            ...
            modelBuilder.Entity("PharmaGo.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<int?>("PharmacyId")
                        .HasColumnType("int")
                        .HasColumnName("Product_PharmacyId");
            ...
            modelBuilder.Entity("PharmaGo.Domain.Entities.PurchaseDetail", b =>
                {
                    b.HasOne("PharmaGo.Domain.Entities.PharmacyItem", "Item")
                        .WithMany()
